...
const imageProviderOptions = ['OpenAI', 'OpenRouter'];
      ...
      <DialogContent className="glass-effect border-white/20 text-white max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input id="conn-name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Ex: OpenAI DALL-E" className="glass-effect border-white/20 text-white" required />
          </div>
          <div>
          ...
          <div>
            <Label htmlFor="conn-api_base_url">URL Base da API (Opcional)</Label>
            <Input id="conn-api_base_url" value={formData.api_base_url} onChange={(e) => setFormData({ ...formData, api_base_url: e.target.value })} placeholder="Ex: https://api.openai.com/v1/images/generations" className="glass-effect border-white/20 text-white" />
          </div>
          <DialogFooter>
