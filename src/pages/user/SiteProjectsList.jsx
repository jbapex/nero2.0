...
import { Plus, Loader2, Trash2, Edit, MoreVertical } from 'lucide-react';
...
const SiteProjectsList = () => {
  ...
  }, [fetchProjects, user, profile, userIsSuperAdmin, navigate, toast]);
  ...
  const handleNavigation = (projectId) => {
    let path;
    if (userIsSuperAdmin) {
      path = isMobile ? `/superadmin/criar-site/${projectId}/mobile` : `/superadmin/criar-site/${projectId}`;
    } else {
      path = isMobile ? `/ferramentas/criador-de-site/${projectId}/mobile` : `/ferramentas/criador-de-site/${projectId}`;
    }
    navigate(path);
  };
  ...
  return (
    <>
      <Helmet>
        <title>Meus Projetos de Site</title>
        <meta name="description" content="Crie e gerencie seus sites gerados por IA." />
      </Helmet>
                  ...
                  <motion.div key={project.id} variants={itemVariants}>
                    <Card className="h-full flex flex-col hover:shadow-primary/20 hover:shadow-lg transition-shadow duration-300 bg-card text-card-foreground border">
                          ...
                          <div>
                           ...
                           <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => handleNavigation(project.id)}>
                      ...
                      <div className="p-4 pt-0 mt-auto">
                        <Button className="w-full" onClick={() => handleNavigation(project.id)}>
